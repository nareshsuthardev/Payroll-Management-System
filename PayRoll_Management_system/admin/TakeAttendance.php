        ...
        <div class="row side-menu" style="height: 100vh;">
            <div class="col-3 bg-dark p-0">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item active"><a href="./TakeAttendance.php" class="alinks"><i class="fal fa-clipboard-user"></i> Take Attendance</a></li>
                </ul>
            ...
            <div class="col-9 ">
                <div class="row">
                    <div class="col-12 TableName-box d-flex justify-content-between">
                        <h1 class="TableName" id="TableName"><i class="fad fa-table"></i> Attendance Book</h1>
                        <ul class="nav justify-content-end subNavbars">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="../index.html"><i class="fad fa-sign-out-alt"></i> Logout</a>
                            </li>
                        </ul>
                    </div>
                    <h3 class="col-12 pt-3"><?php echo "Attendeance Of:     "."  ". date("Y-m-d"); ?></h3>
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr class="bg-warning">
                                    ...
                                    <th scope="col hed">Name</th>
                                    <th scope="col hed">Email Address</th>
                                    <th scope="col hed">Present/ Absent</th>
                                </tr>
                            </thead>
                            <?php
                            $Empl_Table_Query = "SELECT * FROM employee";
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-evenly">
                                                <form action="./AttAttenencePHPCode.php?empid=<?php echo $row['emp_id'] ?>" method="post">
                                                    <button type="submit" name="Present" class="btn btn-primary alert alert-primary mb-0 py-2">Present</button>
                                                    <button type="submit" name="Absent" class="btn btn-danger alert alert-danger mb-0 py-2">Absent</button>
                                                </form>
                                            </td>
                                        </tr>
                                    </tbody>
