    ...
    <div class="container-fluid " style="height: 100vh;">
        <div class="row side-menu" style="height: 100vh;">
            <div class="col-3 bg-dark p-0">
                ...
                <a class="link-heding2 text-decoration-none active"><i class="far fa-calendar-alt"></i> attendance</a>
            ...
            <div class="col-9 ">
                <div class="row">
                    <div class="col-12 TableName-box d-flex justify-content-between">
                        <h1 class="TableName" id="TableName"><i class="fad fa-table"></i> attendence</h1>
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr class="bg-warning">
                                    ...
                                    <th scope="col hed">Employee Name</th>
                                    <th scope="col hed">Date of Attendance</th>
                                    <th scope="col hed">Working Hours</th>
                                    <th scope="col hed">Attendance Status</th>
                                </tr>
                            </thead>
                            <?php
                            $Empl_Table_Query = "SELECT * FROM attendance";
                            ...
                            ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <?php
                                            $dabis = $row["attendance_status"];
                                            if ($dabis == 'Present') {
                                                $AtttdeStY = 'alert-info';
                                            } else {
                                                $AtttdeStY = 'alert-danger';
                                            }
                                            ?>
                                            <td>
                                                <p class="alert <?php echo $AtttdeStY; ?>  mb-0 p-2 text-center  fw-bold"> <?php echo $row["attendance_status"]  ?></p>
                                            </td>
                                        </tr>
                                    </tbody>
