    ...
    <div class="container-fluid " style="height: 100vh;">
        <div class="row side-menu" style="height: 100vh;">
            <div class="col-3 bg-dark p-0">
                ...
                <a class="link-heding2 text-decoration-none active" href="./position.php"><i class="fas fa-briefcase"></i> position</a>
            ...
            <div class="col-9 ">
                <div class="row">
                    <div class="col-12 TableName-box d-flex justify-content-between">
                        <h1 class="TableName" id="TableName"><i class="fad fa-table"></i> Postion</h1>
                    ...
                    <table class="table table-bordered table-striped">
                            <thead>
                                <tr class="bg-warning">
                                    ...
                                    <th  scope="col hed">Position ID</th>
                                    <th scope="col hed">Position Title</th>
                                    <th scope="col hed">Rate per hour</th>
                                    <th scope="col hed">Operations</th>
                                </tr>
                            </thead>
                            <?php
                            $Empl_Table_Query = "SELECT * FROM position";
                            ...
                            ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $row["pos_rate_per_hour"]  ?></td>
